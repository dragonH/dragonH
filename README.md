### Hi there, I'm Jack - aka [dragonH](http://dragonh.github.io) 👋
...
<!-- AWS-NEWS:START -->
- [Amazon EMR Serverless is now available in Amazon Web Services China Regions](https://aws.amazon.com/about-aws/whats-new/2023/05/amazon-emr-serverless-china-regions/)
- [AWS App Mesh now supports AWS PrivateLink](https://aws.amazon.com/about-aws/whats-new/2023/05/aws-app-mesh-supports-aws-privatelink/)
- [Amazon CodeWhisperer now available as extension in JupyterLab and Amazon SageMaker Studio](https://aws.amazon.com/about-aws/whats-new/2023/05/amazon-codewhisperer-extension-jupyterlab-sagemaker-studio/)
- [Amazon Kinesis Data Firehose adds support for document ID that is auto-generated by Amazon OpenSearch Service](https://aws.amazon.com/about-aws/whats-new/2023/05/amazon-kinesis-data-firehose-document-id-amazon-opensearch-service/)
- [AWS Service Management Connector now supports provisioning with Terraform](https://aws.amazon.com/about-aws/whats-new/2023/05/aws-service-management-connector-provisioning-terraform/)
...
- [AWS announces new AWS Direct Connect location in Atlanta, Georgia](https://aws.amazon.com/about-aws/whats-new/2023/05/aws-direct-connect-atlanta-georgia/)
